...
namespace Es.Riam.Gnoss.OAuthAD
{
    public class EntityContextOauth : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                case "0":
                    optionsBuilder.UseSqlServer(mConfigService.ObtenerOauthConnectionString(), o => o.UseCompatibilityLevel(110));
                    break;

                case "1":
                    optionsBuilder.UseOracle(mConfigService.ObtenerOauthConnectionString(), o => o.UseOracleSQLCompatibility(ObtenerNivelCompatibilidadOracle()));
                    break;
