...
namespace Es.Riam.Gnoss.Web.Controles.Proyectos
{
    ...
    public class ControladorProyecto : ControladorBase
    {
		...
		private void CrearFacetasDefectoProyecto(Guid pProyectoID)
        {
            ...
            AgregarFacetaObjetoConocimientoProyecto(new Guid("11111111-1111-1111-1111-111111111111"), pProyectoID, "recurso", "gnoss:haspublicador", 10003, false, TipoPropiedadFaceta.Numero, 0, false, 0, false, 1, 5, TiposAlgoritmoTransformacion.NCer, string.Empty, false, 1, "Publicadores@es|||Publishers@en|||Verlag@de|||Argitaletxeak@eu|||Editores@gl|||Editori@it|||Editores@pt|||Éditeurs@fr|||Publicadors@ca", false, string.Empty, 0, string.Empty, false, false, false, string.Empty, false, false, Guid.NewGuid());

            AgregarFacetaObjetoConocimientoProyecto(new Guid("11111111-1111-1111-1111-111111111111"), pProyectoID, "recurso", "gnoss:hastipodoc", 10007, false, TipoPropiedadFaceta.Texto, 0, false, 0, false, 1, 5, TiposAlgoritmoTransformacion.TipoDoc, string.Empty, false, 1, "Tipo de documento@es|||Document class@en|||Dokumenttyp@de|||Dokumentu mota@eu|||Tipo de documento@gl|||Tipo di documento@it|||Tipo de documento@pt|||Type de document@fr|||Tipus de document@ca", false, string.Empty, 0, string.Empty, false, false, false, string.Empty, false, false, Guid.NewGuid());
