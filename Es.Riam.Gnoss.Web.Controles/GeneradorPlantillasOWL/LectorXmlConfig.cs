...
namespace Es.Riam.Gnoss.Web.Controles.GeneradorPlantillasOWL
{
    ...
    public class LectorXmlConfig
    {
        ...
        private List<XmlNode> GetNodos(XmlNodeList pNodos)
        {
            ...
            {
                //Se omite cualquier nodo que no sea un elemento: comentarios, secciones CDATA y texto suelto que aparece entre etiquetas (saltos de línea, sangrados o caracteres invisibles). Esos nodos no forman parte de la configuración y, al contarse como un nodo más, provocan una lectura errónea del objeto de conocimiento.
