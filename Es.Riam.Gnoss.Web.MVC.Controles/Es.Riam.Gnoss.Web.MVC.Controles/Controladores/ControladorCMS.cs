...
namespace Es.Riam.Gnoss.Web.MVC.Controles.Controladores
{
    public class ControladorCMS : Web.Controles.ControladorBase
    {
        ...
        public CMSComponentResourceList ObtenerFichaListadoDinamico(CMSComponente pComponente, string pIdioma)
        {
            ...
            string urlBusqueda = ReemplazarDatosUsuarioActual(componenteListadoDinamico.URLBusqueda);
        ...
        public CMSComponentProfileSummary ObtenerFichaResumenPerfil(CMSComponenteResumenPerfil pComponente, string pIdioma)
        {
            ...
            if (!EsUsuarioInvitado)
            {
                ...
                int numSeguidores = 0;
                GestionIdentidades gestorIdentidadesSeguidores = new GestionIdentidades(identidadCN.ObtenerIdentidadesSusucritasAPerfil(PerfilID), mLoggingService, mEntityContext, mConfigService, mServicesUtilVirtuosoAndReplication);
        ...
        {
            string idiomaOriginal = IdiomaPorDefecto;
            ...
            if (pUrl.Contains(mControlador.BaseURL + "/"))
            {
                ...
                else if (pUrlAux == utilIdiomasUrlOriginal.GetText("URLSEM", "BUSQUEDAAVANZADA"))
                {
        ...
        public Identidad IdentidadActual
        {
            get
            {
                ...
                else if (mIdentidadActual == null)
                {
                    ...
                    {
                        GestionIdentidades gestorIdentidades = new GestionIdentidades(identCN.ObtenerIdentidadInvitado(), mLoggingService, mEntityContext, mConfigService, mServicesUtilVirtuosoAndReplication);
                        mIdentidadActual = gestorIdentidades.ListaIdentidades[IdentidadID];
                    }
                }
