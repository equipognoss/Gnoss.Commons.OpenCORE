        ...
        {           
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermisosAdministracion = table.Column<decimal>(type: "NUMBER(20)", nullable: false),
                    PermisosContenidos = table.Column<decimal>(type: "NUMBER(20)", nullable: false),
                    PermisosRecursos = table.Column<decimal>(type: "NUMBER(20)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nombre = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Descripcion = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Permisos = table.Column<decimal>(type: "NUMBER(20)", nullable: false),
                    FechaModificacion = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false)
                },
                constraints: table =>
                {
