    ...
    public partial class Flujos : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FlujoID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    Nota = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    Encuesta = table.Column<bool>(type: "bit", nullable: false),
                    Debate = table.Column<bool>(type: "bit", nullable: false),
                    PaginaCMS = table.Column<bool>(type: "bit", nullable: false),
                    ComponenteCMS = table.Column<bool>(type: "bit", nullable: false),
                    RecursoSemantico = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    FlujoID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Ontologia = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    OrganizacionID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProyectoID = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TransicionID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Nombre = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EstadoOrigenID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HistorialTransicionID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
