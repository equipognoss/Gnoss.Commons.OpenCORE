        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VersionAnterior = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProyectoPestanyaMenuVersionPagina_ProyectoPestanyaMenuVersi~",
                        column: x => x.VersionAnterior,
                        principalTable: "ProyectoPestanyaMenuVersionPagina",
                        principalColumn: "VersionID");
                    table.ForeignKey(
                        name: "FK_ProyectoPestanyaMenuVersionPagina_ProyectoPestanyaMenu_Pest~",
