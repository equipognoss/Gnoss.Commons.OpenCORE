        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nota = table.Column<bool>(type: "boolean", nullable: false),
                    Adjunto = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    Debate = table.Column<bool>(type: "boolean", nullable: false),
                    PaginaCMS = table.Column<bool>(type: "boolean", nullable: false),
                    ComponenteCMS = table.Column<bool>(type: "boolean", nullable: false),
                    RecursoSemantico = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    FlujoID = table.Column<Guid>(type: "uuid", nullable: false),
                    Ontologia = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    OrganizacionID = table.Column<Guid>(type: "uuid", nullable: false),
                    ProyectoID = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlujoObjetoConocimientoProyecto_OntologiaProyecto_Organizac~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TransicionID = table.Column<Guid>(type: "uuid", nullable: false),
                    Nombre = table.Column<string>(type: "text", nullable: true),
                    EstadoOrigenID = table.Column<Guid>(type: "uuid", nullable: false),
                    EstadoDestinoID = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HistorialTransicionID = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HistorialTransicionPestanyaCMS_ProyectoPestanyaCMS_Pestanya~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlujoObjetoConocimientoProyecto_OrganizacionID_ProyectoID_O~",
