...
namespace Es.Riam.Gnoss.Logica.Identidad
{
    ...
    public class IdentidadCN : BaseCN, IDisposable
    {
        ...
        /// <summary>
        /// Obtiene los perfiles de las organizaciones pasada por parámetro 
        /// </summary>
        /// <param name="pOrganizacionID">Identificador de la organización</param>
        /// <returns>Dataset de identidades</returns>
        ...
        /// <param name="pIncrementarCompartido">Incremento que hay que hacer en el némero de compartidos (puede ser 0 o negativos)</param>
        /// <param name="pIncrementarComentario">Incremento que hay que hacer en el némero de comentarios (puede ser 0 o negativos)</param>
