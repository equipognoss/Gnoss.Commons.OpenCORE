...
namespace Es.Riam.Gnoss.Logica.BASE_BD
{
    ...
    public class BaseComunidadCN : BaseCN, IDisposable
    {
        ...
        /// </summary>
        /// <param name="pParametrosCorreo">Párametros de configuración del servicio de correo</param>
        ...
        /// <param name="pFechaCreacion">Fecha de creación/compartición de recurso en la comunidad</param>
        ...
        #region M�todos de Ultimos Recursos visitados

        /// <summary>
        /// Obtiene los últimos recursos visitados de un proyecto
        /// </summary>
        /// <param name="pProyectoID">Identificador del proyecto del que se quieren obtener los últimos documentos visitados</param>
        ...
        /// <summary>
        /// Actualiza los últimos recursos visitados de un proyecto
        /// </summary>
        /// <param name="pProyectoID">Identificador del proyecto</param>
