...
namespace Es.Riam.Gnoss.Logica.ServiciosGenerales
{
    ...
    public class ProyectoCN : BaseCN, IDisposable
    {
        ...
        /// </summary>
        /// <param name="pProyectoID">Identificador del proyecto del cual queremos obtener las pestañas</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// obtiene las ´páginas de búsqueda de un proyecto
        /// </summary>
        /// <param name="pProyectoID">Clave del proyecto del que queremos obtener los gadgets</param>
        /// <param name="pDataWrapperProyecto">Dataset de proyectos</param>
        ...
        /// <summary>
        /// Obtiene el id autonuméroco que se le asigna a cada proyecto para crear la tabla BASE
        /// </summary>
        /// <param name="pProyectoID">Identificador del proyecto</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Obtiene el proyecto a partir del id autonuméroco que se le asigna al crear la tabla BASE.
        /// </summary>
        ...
        /// <summary>
        /// Obtiene el identificador proyecto a partir del id autonuméroco que se le asigna al crear la tabla BASE.
        /// </summary>
        /// <param name="pTablaBaseProyectoID">Identificador de la tabla base del proyecto</param>
        ...
        /// <summary>
        /// Obtiene el proyecto en el que participa una identidad (no muestra los que están cerrados)
        /// </summary>
        ...
        /// <summary>
        /// Carga todos los proyectos que se están cerrando --> ProyectoDS (Proyecto,ProyectoCerrandose) 
        /// </summary>
        /// <returns>Dataset de proyectos</returns>
		...
		/// <summary>
		/// Obtiene los tesauros semánticos configurados para edición de todos los proyectos
		/// </summary>
        ...
        /// <param name="pCargarProyectosCerrados">Indica si se cargan todos los proyectos o solo los que no están cerrados</param>
        ...
        /// <summary>
        /// Elimina las entradas de ProyectoPestanyaBusquedaPesoOC para un proyecto y una pestaña determinada
        /// </summary>
        /// <param name="pProyectoID"></param>
		...
		/// <summary>
		/// Inserta las filas en la tabla ProyectoPestanyaBusquedaPesoOC para la configuración del tipo de autocompletado
		/// </summary>
