...
namespace Es.Riam.Gnoss.Logica.Documentacion
{
    ...
    public class DocumentacionCN : BaseCN, IDisposable
    {
        ...
        /// <summary>
        /// Obtiene todos los documentos que están vinculados a un serie de categorias (y las relaciones con otras categoráas).
        /// </summary>
        ...
        ///// <summary>
        ///// Actualiza la puntuación de los recursos más populares en el último mes
        ///// </summary>
        ...
        /// </summary>
        /// <param name="pDocumentoID">Identificador del documento a comprobar</param>
        /// <param name="pProyectoID">Identificador del proyecto en el que se quiere comprobar que está compartido el recurso</param>
        ...
        /// <param name="pTitulo">Variable en la que se devolverá el título del recurso</param>
        ...
        /// <summary>
        /// Devuelve las vinculaciones de los documentos de una organización. Carga "DocumentoWebVinBaseRecursos" , "DocumentoWebAgCatTesauro"
        /// </summary>
        ...
        public DocumentoEnEdicion ComprobarDocumentoEnEdicion(Guid pDocumentoID, Guid pIdentidadID, int pSegundosDuracionBloqueo = 30, int pNumeroIntentos = 3)
        {
        ...
        /// <summary>
        /// Verdad si el documento está marcado como publico sílo para los miembros de la comunidad
        /// </summary>
        /// <param name="pDocumentoID">Identificador del documento</param>
        /// <returns>Verdad si el documento está marcado como publico sílo para los miembros de la comunidad</returns>
