...
namespace Es.Riam.Gnoss.Elementos.Identidad
{
    ...
    public class Identidad : ElementoGnoss
    {
        ...
        /// <summary>
        /// Constructor a partir de los datos pasados como par�metros
        /// </summary>
        ...
        /// <summary>
        /// Obtiene la organizaci�n de la identidad (NULL si es un perfil personal)
        /// </summary>
        ...
        /// <summary>
        /// Obtiene el correo electr�nico que corresponde a la identidad
        /// </summary>
        public string Email
        {
            get
        ...
        /// <summary>
        /// Verdad si la persona est� trabajando por medio de una organizaci�n (Sea Tipo 1,2,3)
        /// </summary>
        ...
        /// <summary>
        /// Verdad si la persona est� trabajando por medio de una organizaci�n (Solo Tipo 1,2)
        /// </summary>
        ...
        /// <summary>
        /// Devuelve el tipo (modo de participaci�n) de una identidad
        /// </summary>
        ...
        /// <summary>
        /// Obtiene la fila de relaci�n de la identidad con la persona 
        ...
        /// <summary>
        /// Obtiene el elemento p�blico de la identidad (Persona u Organizacion)
        /// </summary>
        ...
        /// <summary>
        /// Devuelve la lista de amigos de la persona para la presentaci�n.
        /// </summary>
        ...
        /// <summary>
        /// Lista con los Ids de los grupos de participaci�n de la identidad actual (se construye cada vez que la llamas)
        /// </summary>
        ...
        /// <summary>
        /// Obtiene o establece la lista de perfiles a los que est�s suscrito "Dictionary(PerfilID, UsuarioID)
        /// </summary>
        ...
        /// <summary>
        /// Obtiene el nombre del elemento p�blico
        /// </summary>
        ...
        /// <summary>
        /// Obtiene el nombre de la organizaci�n (en caso de que la identidad no sea personal)
        /// </summary>
        ...
        /// <summary>
        /// Obtiene el identificador de la organizaci�n (en caso de que la identidad no sea personal)
        /// </summary>
        ...
        /// <summary>
        /// Devuelve si la identidad pertenece a una organizaci�n
        /// </summary>
        ...
        /// <summary>
        /// Obtiene o establece el n�mero de recursos compartidos por la identidad
        /// </summary>
        ...
        /// <summary>
        /// Obtiene la identidad de la organizaci�n a la que pertenece el usuario (Modo Corporativo)
        /// </summary>
                ...
                if (mIdentidadOrganizacion == null)
                {
                    if (TrabajaConOrganizacion)
                    {
                        ...
                        if (perfilOrganizacion != null)
                        {
                            ...
                            //Si no encontramos identidades en MyGnoss, cogeremos lo que haya (deber�a estar s�lo el proyecto en el que ha entrado el usuario)
                            if (filasIdentidadesOrganizacion.Count == 0)
                            {
        ...
        /// objeto de cache y la deserializaci�n no las carga en el constructor.
        /// </summary>
        ...
        /// <param name="pServicesUtilVirtuosoAndReplication">Dependencia para gestionar la replicaci�n</param>
        ...
        public Guid ObtenerIdentidadUsuarioEnProyectoConPerfil(Guid pProyectoID, Guid pPerfilID)
        {
            ...
            {
                //Juan Valer: No debe entrar nunca por aqu�, lo pongo porque a habido incongruencias en datos de producci�n 
                //y puede ser porque entra por aqui en alguna ocasi�n. Lanzo este mensaje para que se quede constancia en el log 
