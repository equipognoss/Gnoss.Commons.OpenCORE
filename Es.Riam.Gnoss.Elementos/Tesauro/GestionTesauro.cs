...
namespace Es.Riam.Gnoss.Elementos.Tesauro
{
    ...
    public class GestionTesauro : GestionGnoss, ISerializable
    {
        ...
        /// <summary>
        /// Nombre para la categor�a nueva
        /// </summary>
        public const string NOMBRE_CATEGORIA_NUEVA = "<Nueva categor�a de tesauro>";

        /// <summary>
        /// Nombre de la categor�a de tesauro p�blica
        /// </summary>
        public const string NOMBRE_CATEGORIA_PUBLICA = "Recursos p�blicos";

        /// <summary>
        /// Nombre de la categor�a de tesauro privada
        /// </summary>
        public const string NOMBRE_CATEGORIA_PRIVADA = "Recursos privados";
        /// <summary>
        /// Nombre de la cola que genera las im�genes de la categor�a
        /// </summary>
        ...
        /// <summary>
        /// Lista de categor�as de tesauro
        /// </summary>
        private SortedList<Guid, CategoriaTesauro> mListaCategoriasTesauro;

        private Dictionary<Guid, CategoriaTesauroPropiedades> mFilasPropiedadesPorCategoria = null;

        /// <summary>
        /// Lista de categor�as de tesauro ordenas por nombre en funcion del idioma.
        /// </summary>
        private Dictionary<string, List<CategoriaTesauro>> mListaCategoriasTesauroOrdenadasPorNombre;

        /// <summary>
        /// Lista de categor�as de tesauro de primer nivel
        /// </summary>
        private Dictionary<Guid, CategoriaTesauro> mListaCategoriasTesauroPrimerNivel = new Dictionary<Guid, CategoriaTesauro>();

        /// <summary>
        /// Lista de categor�as de tesauro sugeridas (identificador, categor�a) de primer nivel.
        /// </summary>
        ...
        /// <summary>
        /// Lista de los elementos hijos del gestor de tesauro m�s las sugerencias.
        /// </summary>
        private List<IElementoGnoss> mHijosConSugerencias;

        /// <summary>
        /// N�mero de elementos de la categor�a.
        /// </summary>
        ...
        /// <summary>
        /// Obtiene la lista de categor�as (identificador, categor�a) que contiene el tesauro
        /// </summary>
        ...
        /// <summary>
        /// Obtiene la lista de categor�as ordenadas por nombre que contiene el tesauro en funcion del idioma
        /// </summary>
        ...
        /// <summary>
        /// Obtiene la lista de categor�as de tesauro (identificador, categor�a) de primer nivel
        /// </summary>
        ...
        /// <summary>
        /// Obtiene la lista de categor�as de tesauro sugeridas (identificador, categor�a) de primer nivel.
        /// </summary>
        ...
        public AD.EntityModel.Models.Tesauro.Tesauro FilaTesauroActual
        {
            get
            {
                if (mFilaTesauroActual == null)
                {
                    ...
                    mFilaTesauroActual = TesauroDW.ListaTesauro.FirstOrDefault();
                }
        ...
        #region Tesauro Usuario y Organizaci�n

        /// <summary>
        /// Devuelve el identificador de la categor�a publica del tesauro actual.
        /// </summary>
        ...
        /// <summary>
        /// Devuelve el identificador de la categor�a privada del tesauro actual.
        /// </summary>
        ...
        public bool TesauroDeUsuario
        {
            get
            {
                return TesauroDW.ListaTesauroUsuario.Any(item => item.TesauroID.Equals(TesauroActualID));
            }
        }
        ...
        /// <summary>
        /// Crea un nuevo tesauro para el usuario pasado por par�metro
        /// </summary>
        /// <param name="pUsuarioID">Identificador del usuario</param>
        /// <param name="pNombreCategoriaPublica">Nombre de la categor�a de tesauro p�blica</param>
        /// <param name="pNombreCategoriaPrivada">Nombre de la categor�a de tesauro privada</param>
        ...
        public AD.EntityModel.Models.Tesauro.Tesauro AgregarTesauroUsuario(Guid pUsuarioID, string pNombreCategoriaPublica, string pNombreCategoriaPrivada)
        {
            ...
            //Categor�a del tesauro de usuario
        ...
        /// <summary>
        /// Crea un nuevo tesauro para la organizaci�n pasada por par�metro
        /// </summary>
        ...
        public AD.EntityModel.Models.Tesauro.Tesauro AgregarTesauroOrganizacion(Guid pOrganizacionID, string pNombreCategoriaPublica, string pNombreCategoriaPrivada)
        {
            ...
            Guid categoriaPublica = Guid.NewGuid();
            Guid categoriaPrivada = Guid.NewGuid();
            TesauroOrganizacion filaTesauroOrganizacion = new TesauroOrganizacion();
        ...
        /// <summary>
        /// Eliminar el tesauro cuyo identificador se pasa como par�metro
        /// </summary>
        ...
        public void EliminarTesauro(Guid pTesauroID)
        {
            ...
            // Eliminar tesauro de organizaci�n
        ...
        /// <summary>
        /// Determina si el gestor de tesauro admite como hijo al elemento pasado por par�metro
        /// </summary>
        ...
        {
            if (pHijoCandidato is CategoriaTesauro)
                return true;
            else
                return false;
        }
        ...
        /// <summary>
        /// Carga las categor�as de tesauro
        /// </summary>
        ...
        /// <summary>
        /// Agrega una categor�a al tesauro
        /// </summary>
        /// <param name="pNombre">Nombre de la nueva categor�a</param>
        /// <returns>Nueva categor�a de tesauro</returns>
        public CategoriaTesauro AgregarCategoria(string pNombre, short pOrden, bool pTieneFoto = false)
        {
            ...
            //Creo la fila nueva de categor�a
        ...
        public CategoriaTesauro AgregarSubcategoria(CategoriaTesauro pCategoriaSuperior, string pNombre, bool pTieneFoto = false)
        {
            ...
            //La agrego a su categor�a superior
        ...
        public void ActualizarTieneFoto(Guid pCategoriaID, bool pTieneFoto)
        {
            ...
            if (categoria != null)
            {
                ...
                this.TesauroDW.ListaCategoriaTesauro.Find(cat => cat.CategoriaTesauroID.Equals(pCategoriaID)).TieneFoto = pTieneFoto;
                this.ListaCategoriasTesauro.FirstOrDefault(cat => cat.Key.Equals(pCategoriaID)).Value.FilaCategoria.TieneFoto = pTieneFoto;
            }
        }
        ...
        /// <summary>
        /// Crea una nueva categor�a de tesauro de primer nivel
        /// </summary>
        /// <param name="pNombre">Nombre para la nueva categor�a de tesauro</param>
        /// <returns>Nueva categor�a de tesauro</returns>
        ...
        /// <summary>
        /// Agrega una subcategor�a a la categoria superior
        /// </summary>
        /// <param name="pSubCategoria">Subcategor�a de tesauro</param>
        /// <param name="pCategoriaSuperior">Categor�a de tesauro superior</param>
        /// <returns>El DataRow de agregaci�n creado</returns>
        public CatTesauroAgCatTesauro AgregarSubcategoriaACategoria(CategoriaTesauro pSubCategoria, CategoriaTesauro pCategoriaSuperior, int? orden = null)
        {
            ...
            {
                //Creo la relaci�n entre la categor�a superior y la subcategor�a
        ...
        /// <summary>
        /// Agrega una sugerencia de categor�a debajo de una ya existente.
        /// </summary>
        /// <param name="pCategoriaPadreID">Categor�a padre bajo la que se sugire como hija una nueva o Guid.Empty si est� en la raiz</param>
        /// <param name="pTesauroID">Tesauro en el que se sugiere</param>
        /// <param name="pNombre">Nombre de la categor�a sugerida</param>
        /// <param name="pIdentidadSugiere">Identidad que sugiere la categor�a</param>
        ...
        /// <summary>
        /// Quita de la lista de subcategor�as de la categor�a superior una categor�a
        /// </summary>
        /// <param name="pSubCategoria">Subcategor�a a quitar</param>
        /// <param name="pCategoriaSuperior">Categor�a superior que contiene la subcategor�a</param>
        ...
        /// <summary>
        /// Elimina la categor�a del tesauro y sus hijos
        /// </summary>
        /// <param name="pCategoria">Categor�a de tesauro a eliminar</param>
        ...
        /// <summary>
        /// Elimina la categor�a del tesauro
        /// </summary>
        /// <param name="pCategoria">Categor�a a eliminar</param>
        public void EliminarCategoria(CategoriaTesauro pCategoria, SortedList<Guid, CategoriaTesauro> listaCacheCaducidad)
        {
            ...
            //Borra las sugerencias que cuelgan de la categor�a (aceptadas o sin aceptar)
            ...
            //Eliminamos las suscripciones de usuarios a la categor�a que vamos a eliminar
            ...
            //Eliminamos finalmente la categor�a
        ...
        /// <summary>
        /// Comprueba si al categor�a est� vinculada
        /// </summary>
        /// <param name="pCategoria">Categor�a a comprobar</param>
        /// <returns>TRUE si la categor�a est� vinculada, FALSE en caso contrario</returns>
        ...
        /// <summary>
        /// Carga el n� de elementos de cada categor�a.
        /// </summary>
        ...
        /// <summary>
        /// Elimina las categor�as que no est�n permitidas por un tipo de documento y su ontolog�a si la tiene.
        /// </summary>
        /// <param name="pTipoDoc">Tipo de documento para revisar</param>
        /// <param name="pOntologiaID">ID de la ontolog�a a revisar o NULL si no hay ontolog�a</param>
        public void EliminarCategoriasNoPermitidasPorTipoDoc(short pTipoDoc, Guid? pOntologiaID)
        {
            if (TesauroDW.ListaCatTesauroPermiteTipoRec.Any(item => item.TipoRecurso.Equals(pTipoDoc)))
            {
                List<Guid> catMantener = new List<Guid>();

                List<CatTesauroPermiteTipoRec> listaProvisional = TesauroDW.ListaCatTesauroPermiteTipoRec.Where(item => item.TipoRecurso.Equals(pTipoDoc)).ToList();
                ...
                {
                    List<IElementoGnoss> hijosAux = Hijos;
        ...
        /// <summary>
        /// Elimina las categor�as que son p�blicas cuando el metaEspacio es GNOSS.
        /// </summary>
        public void EliminarCategoriasPublicasSiEsMetaEspacioGNOSS(string pLanguageCode)
        {
            ...
            //2 borramos las categor�as tesauro del resto de listas del gestor tesauro
            foreach (CategoriaTesauro catTesauro in catsRemovidas)
            {
                ...
                if (ListaCategoriasTesauroYCategoriasSugeridasPrimerNivel != null)
                {
                    foreach (ElementoGnoss eg in ListaCategoriasTesauroYCategoriasSugeridasPrimerNivel.Where(item => item.Clave.Equals(catTesauro.Clave)))
                    {
                ...
                TesauroDW.ListaCategoriaTesauro.Remove(TesauroDW.ListaCategoriaTesauro.Find(item => item.CategoriaTesauroID.Equals(catTesauro.Clave)));
            }
        }
        ...
        private List<CategoriaTesauro> EliminarCategoriasHijas(CategoriaTesauro pPadre)
        {
            ...
            List<IElementoGnoss> hijosAux = pPadre.Hijos;
        ...
        /// <summary>
        /// Obtiene las categor�as que tengan un determinado nombre.
        /// </summary>
        /// <param name="pNombre">Nombre de categor�a</param>
        /// <returns>Categor�as que tengan un determinado nombre</returns>
